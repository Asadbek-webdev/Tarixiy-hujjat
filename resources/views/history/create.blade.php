<x-app-layout>
    ...
    <div class="container mx-auto max-w-4xl py-8 px-4">
        ...
        <form action="{{ route('history.store') }}" method="POST" class="bg-white shadow-md rounded-lg p-6"
            enctype="multipart/form-data"  style="height: 450px">
            @csrf
            ...
            <div class="flex justify-end h-8">
                ...
                style="height: 100px"
                    class="h-8 rounded-md border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-gray-700 w-full py-2 px-4 bg-white hover:bg-gray-50"
                    multiple>
